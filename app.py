...
from model import model_train, model_load, model_predict, xmodel_predict
...
def predict():
    ...
    '''
    print(request.json['query']["country"], request.json['query']["year"], request.json['query']["month"], request.json['query']["day"] )
    print(type(request.json['query']["country"]))

    _result = model_predict(request.json['query']["country"], request.json['query']["year"], request.json['query']["month"], request.json['query']["day"])
    '''
    print('... request: ',request.json['query'])
    result = xmodel_predict(request.json['query'])
    print('... result: ',result)
    """
    result = {}
